...
import {
  buildCommentPaletteMap,
  normalizeCellValue,
  resolveCommentBadgePreset as resolveBadgePresetFromPalette,
} from "./grid-renderer-state.js";
...
function createGridRenderer({
  ...
  function getCommentPalette() {
    ...
    const map = buildCommentPaletteMap(paletteSource);
